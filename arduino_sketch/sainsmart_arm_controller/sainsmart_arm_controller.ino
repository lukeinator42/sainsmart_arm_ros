...
double interface_rotation_offset = 0;
//define max ranges
...
double gripper_slider_min = 0;
double gripper_slider_max = 165;
...
void servo_cb(const sensor_msgs::JointState& cmd_msg) {
  ...
  interface_rotation_angle = radiansToDegrees(cmd_msg.position[5]) + interface_rotation_offset;
  ...
  gripper_slider_pos = cmd_msg.position[6]*16500.0;

  if (gripper_slider_pos < gripper_slider_min)
    gripper_slider_pos = gripper_slider_min;

  if (gripper_slider_pos > gripper_slider_max)
    gripper_slider_pos = gripper_slider_max;
  ...
  gripper_slider.write(gripper_slider_pos);
...
void setup() {
  ...
  wrist_rotation.write(wrist_rotation_angle);
  interface_rotation.write(interface_rotation_angle + interface_rotation_offset);
  gripper_slider.write(gripper_slider_pos);
}
